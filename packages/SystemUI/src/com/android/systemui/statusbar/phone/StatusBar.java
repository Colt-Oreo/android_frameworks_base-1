...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private void tick(StatusBarNotification n, boolean firstTime) {
    ...
    private SettingsObserver cSettingsObserver = new SettingsObserver(mHandler);
